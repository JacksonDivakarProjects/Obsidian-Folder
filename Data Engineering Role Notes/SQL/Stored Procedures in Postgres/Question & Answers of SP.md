...
Answers to recurring questions about PL/pgSQL stored procedures: the `:=` assignment operator, capturing `OUT` parameters after a `CALL`, default parameter modes, and variable declaration styles.
...
- [[IN, OUT, INOUT Parameters|Comprehensive Guide to IN, OUT, and INOUT Parameters in PostgreSQL]]
