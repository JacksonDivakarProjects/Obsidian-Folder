...
4. **Always include** a correlation condition (`inner.column = outer.column`).
5. **Remember**: the subquery checks existence only, not the actual values it returns.
...
## 🔗 Related Notes
- [[ALL, ANY, LIKE Keywords|SQL Keywords Quick Reference: ALL, ANY, LIKE]]
