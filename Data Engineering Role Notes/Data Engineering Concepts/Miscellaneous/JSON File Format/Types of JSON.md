...
Very common in API responses and real-world data structures. This is exactly the shape `pandas.json_normalize()` is built to flatten (see [[JSON with Python|JSON with Python]]).
...
## 🔗 Related Notes
- [[JSON with Python|JSON with Python]]
